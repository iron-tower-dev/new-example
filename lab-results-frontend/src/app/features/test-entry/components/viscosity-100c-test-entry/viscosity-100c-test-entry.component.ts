...
@Component({
    selector: 'app-viscosity-100c-test-entry',
    standalone: true,
        ...
        <div class="viscosity-test-container">
            ...
            @if (testResultHistory().length > 0) {
                <mat-card class="history-card">
                    <mat-card-header>
                        <mat-card-title>Last 12 Results for Viscosity @ 100°C Test</mat-card-title>
                    </mat-card-header>
                    <mat-card-content>
...
export class Viscosity100cTestEntryComponent implements OnInit, OnDestroy {
    ...
    testId = 6; // Viscosity @ 100°C test ID - this should come from route or configuration
